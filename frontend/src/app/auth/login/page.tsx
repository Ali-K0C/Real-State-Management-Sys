...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md px-4 py-12 animate-fade-in-up">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled={loading}
                className="h-12 bg-gray-50 border-gray-200 focus:ring-emerald-500 focus:border-emerald-500"
              />
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500">
              ...
              <Link href="/auth/register" className="text-emerald-600 hover:text-emerald-700 font-medium transition-colors">
                Create one now
              </Link>
            </p>
          </div>
